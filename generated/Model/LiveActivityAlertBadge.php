    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling LiveActivityAlertBadge., must be bigger than or equal to 1.');
        }
     ...
     * Sets color
     *
     * @param \ActivitySmith\Generated\Model\LiveActivityColor|null $color Optional badge color.
     *
     * @return self
     */
