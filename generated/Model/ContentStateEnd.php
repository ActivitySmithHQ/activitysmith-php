...
class ContentStateEnd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets numberOfSteps
     *
     * @param int|null $numberOfSteps Total number of steps. Use for type=segmented_progress. Optional on end, and safe to change if the final workflow used more or fewer steps than originally planned.
     *
     * @return self
     */
    ...
    public function setMetrics($metrics)
    {
        ...
        if ((count($metrics) > 8)) {
            throw new \InvalidArgumentException('invalid value for $metrics when calling ContentStateEnd., number of items must be less than or equal to 8.');
        }
        if ((count($metrics) < 1)) {
     ...
     * Sets color
     *
     * @param string|null $color Optional. Accent color for progress, segmented_progress, and metrics Live Activities.
     *
     * @return self
     */
