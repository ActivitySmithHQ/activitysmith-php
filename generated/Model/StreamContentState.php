...
class StreamContentState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets value
     *
     * @param \ActivitySmith\Generated\Model\LiveActivityValue|null $value For type=value, the required prominent readout (string or finite number); strings preserve exact formatting. For progress, a numeric progress value used with upper_limit.
     *
     * @return self
     */
