 ...
 */
class ContentStateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentStateUpdate';
    ...
    */
    ...
    public function setNumberOfSteps($numberOfSteps)
    {
        ...
        if (($numberOfSteps < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberOfSteps when calling ContentStateUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setPercentage($percentage)
    {
        ...
        if (($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling ContentStateUpdate., must be smaller than or equal to 100.');
        }
        if (($percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling ContentStateUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setMetrics($metrics)
    {
        ...
        if ((count($metrics) > 8)) {
            throw new \InvalidArgumentException('invalid value for $metrics when calling ContentStateUpdate., number of items must be less than or equal to 8.');
        }
        if ((count($metrics) < 1)) {
